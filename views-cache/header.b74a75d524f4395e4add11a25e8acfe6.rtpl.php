            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        ...
                        <h1><a href="/"><img src="/res/site/img/logo.png"></a> ERIS MEGASTORE </div>
                        </h1>
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - 
                              <span class="cart-amunt"> $RS <?php echo getCartVlSubTotal(); ?> </span> <i class="fa fa-shopping-cart"></i> 
                              <span class="product-count"><?php echo getCartQtd(); ?></span>
                        </a>
                    </div>
                </div>
            </div>
